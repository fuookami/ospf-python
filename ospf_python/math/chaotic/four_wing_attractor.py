...
Chaotic: Four-wing attractor.

四翼吸引子是一种具有四翼蝴蝶形状的三维混沌系统。
Four-wing attractor is a 3D chaotic system with a
four-wing butterfly shape.
"""
...
class FourWingAttractor:
    ...
    Four-wing attractor, a 3D chaotic system.

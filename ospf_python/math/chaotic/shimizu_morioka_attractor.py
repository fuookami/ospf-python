"""混沌：Shimizu-Morioka 吸引子。

Chaotic: Shimizu-Morioka attractor.

Shimizu-Morioka 系统是一种简化的 Lorenz 型混沌系统。
Shimizu-Morioka system is a simplified Lorenz-type chaotic system.
"""
...
class ShimizuMoriokaAttractor:
    """Shimizu-Morioka 吸引子，三维混沌系统。

    Shimizu-Morioka attractor, a 3D chaotic system.

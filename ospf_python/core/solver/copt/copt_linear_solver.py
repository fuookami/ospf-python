...
基于 coptpy 的 LP/MILP 求解器实现。
LP/MILP solver implementation based on coptpy.
"""
...
class CoptLinearSolver(CoptSolver, LinearSolver):
    """COPT 线性求解器 / COPT linear solver.

    冻结数据类，实现 LinearSolver 接口，使用 coptpy
    求解 LP 和 MILP 问题。
    Frozen dataclass implementing the LinearSolver interface,
    using coptpy to solve LP and MILP problems.
    ...
    def solve(
        ...
        *,
        ...
        使用 coptpy 求解 LP/MILP 问题。
        Uses coptpy to solve LP/MILP problems.

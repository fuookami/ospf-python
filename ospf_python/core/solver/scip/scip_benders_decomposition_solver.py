"""SCIP Benders 分解求解器 / SCIP Benders decomposition
solver.

实现基于 pyscipopt 的 Benders 分解算法框架。
...
class ScipBendersDecompositionSolver(ScipSolver):
    """SCIP Benders 分解求解器 / SCIP Benders decomposition
    solver.
        ...
        *,
        ...
        try:
            ...
            for _ in range(self.max_iterations):
                m.optimize()
                status = self._map_scip_status(m)
    ...
    def _add_cuts(
        ...
        """向主问题添加割 / Add cuts to the master problem.

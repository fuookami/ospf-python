"""Gurobi 异步求解器包装器 / Gurobi async solver wrapper.

为 Gurobi 求解器提供异步求解能力。
Provides asynchronous solve capability for the Gurobi
solver.
"""
...
class PluginSolverAsync(CoreSolverAsync):
    """Gurobi 异步求解器包装器 / Gurobi async solver
    wrapper.
